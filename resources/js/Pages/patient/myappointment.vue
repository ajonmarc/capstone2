...
// Delete Doctor
const deleteAppointment = (booking) => {
    Swal.fire({
        title: "Are you sure?",
        ...
        if (result.isConfirmed) {
            ...
            Inertia.delete(route("booking.destroy", booking.id), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
                        ...
                        >
                            ...
                            >
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3">Reply</th>
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td class="px-4 py-3">
                                        <button
                                            @click="deleteAppointment(booking)"
