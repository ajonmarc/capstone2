        ...
        <form @submit.prevent="submit" class="max-w-md mx-auto">
            ...
            <div class="relative z-0 w-full mb-5 group">
                ...
                <select
                    id="role"
                    v-model="form.role"
                    class="-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  border-gray-600 placeholder-gray-400  focus:ring-blue-500 focus:border-blue-500"
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <button
                                type="button"
                                @click="openAddModal"
                                class=" bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-blue-800"
                            >
                                Add User
                            </button>
                        </div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div
                                            ...
                                            :id="'dropdown-' + user.id"
                                            class="absolute right-0 mt-36 z-10 w-12 bg-white rounded-lg shadow-lg divide-y divide-gray-100  divide-gray-600 border border-gray-200"
                                        >
                                            <ul
                                            ...
                                            >
                                                <li>
                                                    <a
                                                        ...
                                                        "
                                                        href="#"
                                                        class="block py-2 px-4 hover:-100 hover:-600 hover:"
                                                    >
                                                        <i
