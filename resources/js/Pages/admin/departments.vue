...
function handleInputChange() {
    if (searchQuery.value === "") {
        Inertia.get(route("admin.departments"), {}, { preserveState: true });
    }
}
...
const isAddDep = ref(false);
const dialogVisible = ref(false);
const currentDepartment = ref(null); // track current dep
...
const openEditDep = (department) => {
    isAddDep.value = false;
    dialogVisible.value = true;
    currentDepartment.value = department;

    // Pre-fill form
    form.titledep = department.titledep;
    form.imagedep = null;
};
...
const submit = () => {
    if (isAddDep.value) {
        ...
        // Handle edit user
        form.post(route("department.update", currentDepartment.value.id), {
            onSuccess: () => {
                closeModal();
                Swal.fire({
                    title: "Success!",
...
const deleteDepartment = (department) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.delete(route("department.destroy", department.id), {
                onSuccess: () => {
                    Swal.fire({
                        title: "Deleted!",
...
<template>
    ...
    <el-dialog
        ...
        :title="isAddDep ? 'Add Departments' : 'Edit Departments'"
        width="500"
        ...
        <form @submit.prevent="submit" class="max-w-md mx-auto">
            <div class="relative z-0 w-full mb-5 group">
                <input
                    ...
                    autofocus
                    autocomplete="titledep"
                    placeholder=" "
                />
                <InputError class="mt-1" :message="form.errors.titledep" />
                <label
                    for="titledep"
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input
                    ...
                    placeholder=" "
                />
                <InputError class="mt-1" :message="form.errors.imagedep" />
                <label
                    for="imagedep"
                    class="peer-focus:font-medium absolute text-sm text-gray-500 text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                    >imagedep</label
        ...
        <div class="py-5">
            ...
            <div class="bg-white -800 relative shadow-md sm:rounded-lg">
                ...
                <div class="overflow-x-auto">
                    ...
                    >
                        ...
                        >
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">titledep</th>
                    ...
                    <!-- Pagination Links -->
                    <div v-if="departments.links.length > 1">
                        <nav
                                    ...
                                    <a
                                        ...
                                        :class="[
                                            ...
                                            link.active
                                                ...
                                                : 'text-gray-500 bg-white border-gray-300 hover:text-gray-700',
                                        ]"
                                        v-html="link.label"
